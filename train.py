...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_train', type=str,
                        default='../data_bcp/bcp_affine_rigid/val/src', dest='src_train') # ../data/bcp_affine_rigid/bcp_affine/val/src../data_bcp_affine/train/src
    parser.add_argument('--tgt_train', type=str,
                        default='../data_bcp/bcp_affine_rigid/val/tgt', dest='tgt_train') #../data_bcp_affine/train/tgt
    parser.add_argument('--src_val', type=str,
                        default='../data_bcp/bcp_affine_rigid/val/src', dest='src_val') #../data_bcp_affine/train/tgt
    parser.add_argument('--tgt_val', type=str,
                        default='../data_bcp/bcp_affine_rigid/val/tgt', dest='tgt_val') #../data_bcp_affine/val/tgt
    ...
    for e in range(epoch_start, epoch+1):
        ...
        for batch in tqdm(train_loader):
            ...
            img_loss = imgloss_func(pred_tgt, tgt)
        ...
        with torch.no_grad():
            ...
            for batch in tqdm(val_loader):
                ...
                time = torch.cat([mo1, mo2], dim=1)
                pred_tgt = model(src/3, time)*3
